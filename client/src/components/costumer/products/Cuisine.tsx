...
const Cuisine: React.FC<CuisineProps> = ({
    ...
    return (
        <div className="active:scale-95 active:opacity-95 transition duration-150 flex flex-col items-center w-[8.75rem] h-[8.75rem] min-[390px]:w-[10rem] relative min-[390px]:h-[10rem] overflow-y-hidden bg-gradient-to-t rounded-2xl shadow-md to-lightbrown from-darkbrown">
            <div
