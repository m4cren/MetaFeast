...
const WaitingPaymentConfirmation = ({
    ...
    return (
        <div className="fixed w-full gap-2 h-screen flex justify-center items-center flex-col bg-black/20 backdrop-blur-[12px] [-webkit-backdrop-filter:blur(12px)] ">
            <span className="loader-white mb-15 opacity-70 min-[580px]:scale-150  min-[580px]:mb-30 "></span>
            <h1 className="text-primary text-[1.5rem] min-[390px]:text-[1.7rem] min-[580px]:text-[2.3rem] text-center text-shadow-md">
