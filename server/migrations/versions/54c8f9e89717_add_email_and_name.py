...
def upgrade():
    ...
    with op.batch_alter_table('administrator', schema=None) as batch_op:
        batch_op.add_column(sa.Column('admin_name', sa.String(length=125), nullable=True))
        batch_op.add_column(sa.Column('admin_email', sa.String(length=125), nullable=True))
