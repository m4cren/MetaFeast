...
USER_AGENT_PARSERS = [
    ...
    UserAgentParser(
        "(OculusBrowser)/(\\d+)\\.(\\d+).0.0(?:\\.([0-9\\-]+)|)", "Oculus Browser"
    ),
...
DEVICE_PARSERS = [
    ...
    DeviceParser(
        "Mozilla.{0,200}(AspiegelBot|PetalBot)", None, "Spider", "Spider", "Desktop"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(A13-MID)(?: Build|\\) AppleWebKit)", None, "$1", "Allwinner", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "^(?:AMOI|Amoi)[ _]([^;/]{1,100}?) Linux", None, "Amoi $1", "Amoi", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; (@TAB-[^;/]{1,100}?)(?: Build|\\) AppleWebKit)", None, "$1", "Attab", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(JC-[^;/]*)(?: Build|\\) AppleWebKit)", None, "Benss $1", "Benss", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(AX5\\d+)(?: Build|\\) AppleWebKit)", None, "$1", "Bmobile", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(CT)-?(\\d+)(?: Build|\\) AppleWebKit)", None, "$1$2", "Celkon", "$1$2"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(TPC[0-9]{4,5})(?: Build|\\) AppleWebKit)", None, "$1", "ChangJia", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(001DL)(?: Build|\\) AppleWebKit)", None, "Dell $1", "Dell", "Streak"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(Mini-3iX)(?: Build|\\) AppleWebKit)", None, "Dell $1", "Dell", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(HT-03A)(?: Build|\\) AppleWebKit)", None, "$1", "HTC", "Magic"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}Explay[_ ](.{1,200}?)(?:[\\)]| Build)", None, "$1", "Explay", "$1"
    ),
    DeviceParser(
        "; {0,2}(IQ.{0,200}?)(?: Build|\\) AppleWebKit)", None, "$1", "Fly", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(Glass \\d+)(?: Build|\\) AppleWebKit)", None, "$1", "Google", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(PAD1016)(?: Build|\\) AppleWebKit)", None, "Haipad $1", "Haipad", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "Build/HCL ME Tablet ([^;\\)]{1,3})[\\);]", None, "HCLme $1", "HCLme", "$1"
    ),
    ...
    DeviceParser(
        "; {0,2}(PlayBook)(?: Build|\\) AppleWebKit)", None, "HP $1", "HP", "$1"
    ),
    DeviceParser(
        "; {0,2}HP ([^/]{1,50})(?: Build|\\) AppleWebKit)", None, "HP $1", "HP", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}([^;]{1,200}) Build/(?:Huawei|HUAWEI)", None, "$1", "Huawei", "$1"
    ),
    ...
    DeviceParser(
        "; {0,2}((?:[A-Z]{3})\\-L[A-Za0-9]{2})[\\)]", None, "Huawei $1", "Huawei", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}HTC[ _]([^;]{1,200}); Windows Phone", None, "HTC $1", "HTC", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}itel ([^;/]*)(?: Build|\\) AppleWebKit)", None, "Itel $1", "Itel", "$1"
    ),
    DeviceParser(
        "; {0,2}(DE88Plus|MD70)(?: Build|\\) AppleWebKit)", None, "$1", "Ivio", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(IS11CA)(?: Build|\\) AppleWebKit)", None, "$1", "Casio", "GzOne $1"
    ),
    DeviceParser(
        "; {0,2}(IS11LG)(?: Build|\\) AppleWebKit)", None, "$1", "LG", "Optimus X"
    ),
    DeviceParser(
        "; {0,2}(IS11N)(?: Build|\\) AppleWebKit)", None, "$1", "Medias", "$1"
    ),
    DeviceParser(
        "; {0,2}(IS11PT)(?: Build|\\) AppleWebKit)", None, "$1", "Pantech", "MIRACH"
    ),
    DeviceParser(
        "; {0,2}(IS12F)(?: Build|\\) AppleWebKit)", None, "$1", "Fujitsu", "Arrows ES"
    ),
    DeviceParser(
        "; {0,2}(IS12M)(?: Build|\\) AppleWebKit)", None, "$1", "Motorola", "XT909"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(ISW11F)(?: Build|\\) AppleWebKit)", None, "$1", "Fujitsu", "Arrowz Z"
    ),
    DeviceParser(
        "; {0,2}(ISW11HT)(?: Build|\\) AppleWebKit)", None, "$1", "HTC", "EVO"
    ),
    DeviceParser(
        "; {0,2}(ISW11K)(?: Build|\\) AppleWebKit)", None, "$1", "Kyocera", "DIGNO"
    ),
    DeviceParser(
        "; {0,2}(ISW11M)(?: Build|\\) AppleWebKit)", None, "$1", "Motorola", "Photon"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(ISW12HT)(?: Build|\\) AppleWebKit)", None, "$1", "HTC", "EVO 3D"
    ),
    ...
    DeviceParser(
        "; {0,2}(TAB-1012)(?: Build|\\) AppleWebKit)", None, "Lenco $1", "Lenco", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(A1_07|A2107A-H|S2005A-H|S1-37AH0) Build", None, "$1", "Lenovo", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(ThinkPad) ?(Tablet) Build/", None, "Lenovo $1 $2", "Lenovo", "$1 $2"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "\\b(?:Lenovo|LENOVO)+[ _\\-]?([^,;:/ ]+)", None, "Lenovo $1", "Lenovo", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(LG[ \\-]|LG)([^;/]{1,100})[;/]? Build", None, "$1$2", "LG", "$2"
    ),
    DeviceParser(
        "^(LG)-([^;/]{1,100})/ Mozilla/.{0,200}; Android", None, "$1 $2", "LG", "$2"
    ),
    ...
    DeviceParser(
        "; {0,2}(Milestone )(XT[^;/]*) Build", None, "Motorola $1$2", "Motorola", "$2"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(Moto[_ ]?|MOT\\-)([^;/]{1,100}) Build", None, "$1$2", "Motorola", "$2"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(myTab[^;/]*)(?: Build|\\) AppleWebKit)", None, "$1", "Mytab", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(N-\\d+[CDE])(?: Build|\\) AppleWebKit)", None, "$1", "Nec", "$1"
    ),
    DeviceParser(
        "; ?(NEC-)(.{0,200}?)(?: Build|\\) AppleWebKit)", None, "$1$2", "Nec", "$2"
    ),
    DeviceParser(
        "; {0,2}(LT-NA7)(?: Build|\\) AppleWebKit)", None, "$1", "Nec", "Lifetouch Note"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "^(MID7500|MID\\d+) Mozilla/5\\.0 \\(iPad;", None, "Omega $1", "Omega", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(A1601)(?: Build|\\) AppleWebKit)", None, "Oppo F1s", "Oppo", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(TP-\\d+)(?: Build|\\) AppleWebKit)", None, "Orion $1", "Orion", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(MOB-[^;/]{1,100}?)(?: Build|\\) AppleWebKit)", None, "$1", "POV", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(SBM(?:003SH|005SH|006SH|007SH|102SH)) Build", None, "$1", "Sharp", "$1"
    ),
    DeviceParser(
        "; {0,2}(003P|101P|101P11C|102P) Build", None, "$1", "Panasonic", "$1"
    ),
    ...
    DeviceParser(
        "; {0,2}(ST\\d{4}.{0,200})Build/ST", None, "Trekstor $1", "Trekstor", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(NW-Z1000Series)(?: Build|\\) AppleWebKit)", None, "$1", "Sony", "$1"
    ),
    ...
    DeviceParser(
        "; {0,2}(Sprint )(.{1,200}?) {0,2}(?:Build|[;/])", None, "$1$2", "Sprint", "$2"
    ),
    ...
    DeviceParser(
        "; {0,2}(T-Hub2)(?: Build|\\) AppleWebKit)", None, "$1", "Telstra", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}Build/.{0,200} (TOLINO_BROWSER)", None, "$1", "Thalia", "Tolino Shine"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "\\b(T-Mobile)_([^_]+)_(.{0,200}) Build", None, "$1 $2 $3", "Tmobile", "$2 $3"
    ),
    DeviceParser("\\b(T-Mobile)[_ ]?(.{0,200}?)Build", None, "$1 $2", "Tmobile", "$2"),
    DeviceParser(
        " (ATP[0-9]{4})(?: Build|\\) AppleWebKit)", None, "$1", "Tomtec", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(A10 [Bb]asic2?)(?: Build|\\) AppleWebKit)", None, "$1", "Treq", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}(X-?5|X-?3)(?: Build|\\) AppleWebKit)", None, "$1", "Umeox", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        " (VT\\d{2}[A-Za-z]*)(?: Build|\\) AppleWebKit)", None, "$1", "Videocon", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "(Vodafone) (.{0,200}?)(?: Build|\\) AppleWebKit)", None, "$1 $2", "$1", "$2"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; {0,2}((MIX) ([^;/]*)) (Build|MIUI)/", None, "XiaoMi $1", "XiaoMi", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; ?(KFOT|Kindle Fire) Build\\b", None, "Kindle Fire", "Amazon", "Kindle Fire"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "; ?(KFTT) Build\\b", None, "Kindle Fire HD", "Amazon", 'Kindle Fire HD 7"'
    ),
    DeviceParser(
        "; ?(KFJWI) Build\\b",
        None,
    ...
    DeviceParser(
        "\\(Symbian(?:/3|); U; ([^;]{1,200});", None, "Nokia $1", "Nokia", "$1"
    ),
    DeviceParser(
        "BB10; ([A-Za-z0-9\\- ]+)\\)", None, "BlackBerry $1", "BlackBerry", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "webOS.{0,200}(P160U(?:NA|))/(\\d+).(\\d+)", None, "HP Veer", "HP", "Veer"
    ),
    DeviceParser("(Touch[Pp]ad)/\\d+\\.\\d+", None, "HP TouchPad", "HP", "TouchPad"),
    DeviceParser(
        "HPiPAQ([A-Za-z0-9]{1,20})/\\d+\\.\\d+", None, "HP iPAQ $1", "HP", "iPAQ $1"
    ),
    DeviceParser(
        "PDA; (PalmOS)/sony/model ([a-z]+)/Revision", None, "$1", "Sony", "$1 $2"
    ),
    ...
    DeviceParser(
        "CFNetwork/.{0,100} Darwin/\\d", None, "iOS-Device", "Apple", "iOS-Device"
    ),
    DeviceParser(
        "Outlook-(iOS)/\\d+\\.\\d+\\.prod\\.iphone", None, "iPhone", "Apple", "iPhone"
    ),
    DeviceParser("acer_([A-Za-z0-9]+)_", None, "Acer $1", "Acer", "$1"),
    DeviceParser(
        "(?:ALCATEL|Alcatel)-([A-Za-z0-9\\-]+)", None, "Alcatel $1", "Alcatel", "$1"
    ),
    ...
    DeviceParser(
        "^.{0,50}?([A-Za-z0-9]{1,30})_W;FOMA", None, "DoCoMo $1", "DoCoMo", "$1"
    ),
    DeviceParser(
        "^.{0,50}?([A-Za-z0-9]{1,30});FOMA", None, "DoCoMo $1", "DoCoMo", "$1"
    ),
    DeviceParser(
    ...
    DeviceParser("HUAWEI ([A-Za-z0-9\\-]+)", None, "Huawei $1", "Huawei", "$1"),
    DeviceParser(
        "vodafone([A-Za-z0-9]+)", None, "Huawei Vodafone $1", "Huawei", "Vodafone $1"
    ),
    ...
    DeviceParser(
        "(?:InettvBrowser|TSBNetTV|NETTV|HBBTV)", None, "Inettv", "Generic_Inettv"
    ),
    DeviceParser(
        "Series60/\\d\\.\\d (LG)[\\-]?([A-Za-z0-9 \\-]+)", None, "$1 $2", "$1", "$2"
    ),
    DeviceParser(
    ...
    DeviceParser(
        "(?:^LG[\\-]?|^LGE[\\-/]?)([A-Za-z]+[0-9]+[A-Za-z]*)", None, "LG $1", "LG", "$1"
    ),
    DeviceParser("^LG([0-9]+[A-Za-z]*)", None, "LG $1", "LG", "$1"),
    DeviceParser(
        "(KIN\\.[^ ]+) (\\d+)\\.(\\d+)", None, "Microsoft $1", "Microsoft", "$1"
    ),
    ...
    DeviceParser(
        "Softbank/[12]\\.0/([A-Za-z0-9]+)", None, "Softbank $1", "Softbank", "$1"
    ),
    DeviceParser(
        "SonyEricsson ?([A-Za-z0-9\\-]+)", None, "Ericsson $1", "SonyEricsson", "$1"
    ),
    DeviceParser("Android [^;]{1,200}; ([^ ]+) (Sony)/", None, "$2 $1", "$2", "$1"),
    DeviceParser(
        "(Sony)(?:BDP\\/|\\/|)([^ /;\\)]+)[ /;\\)]", None, "$1 $2", "$1", "$2"
    ),
    ...
    DeviceParser(
        "Puffin/[\\d\\.]+AP", None, "Generic Smartphone", "Generic", "Smartphone"
    ),
    DeviceParser(
