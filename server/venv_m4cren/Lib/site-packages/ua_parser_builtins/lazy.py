...
MATCHERS: Tuple[List[UserAgentMatcher], List[OSMatcher], List[DeviceMatcher]] = (
    [
        ...
        UserAgentMatcher(
            "Mozilla.{1,100}Mobile.{1,100}(AspiegelBot|PetalBot)", "Spider"
        ),
    ...
    [
        ...
        DeviceMatcher(
            "ARCHOS; GOGI; ([^;]{1,200});", None, "Archos $1", "Archos", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "; {0,2}(G1)(?: Build|\\) AppleWebKit)", None, "$1", "Galapad", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "; {0,2}(M702pro)(?: Build|\\) AppleWebKit)", None, "$1", "Iru", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "; {0,2}([^;]{1,200}) Build/Karbonn", None, "$1", "Karbonn", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "; {0,2}(IS04)(?: Build|\\) AppleWebKit)", None, "$1", "Regza", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "; {0,2}(ISW13HT)(?: Build|\\) AppleWebKit)", None, "$1", "HTC", "J"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "; {0,2}(3GC101|3GW10[01]|A390) Build/", None, "$1", "Lenovo", "$1"
        ),
        DeviceMatcher(
            "\\b(?:Lenovo|LENOVO)+[ _\\-]?([^,;:/ ]+)",
            None,
        ...
        DeviceMatcher(
            "; RCA (\\w+)(?: Build|\\) AppleWebKit)", None, "RCA $1", "RCA", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "; {0,2}(T-Mobile[ _]G2[ _]Touch) Build", None, "$1", "HTC", "Hero"
        ),
        DeviceMatcher("; {0,2}(T-Mobile[ _]G2) Build", None, "$1", "HTC", "Desire Z"),
        DeviceMatcher(
            "; {0,2}(T-Mobile myTouch Q) Build", None, "$1", "Huawei", "U8730"
        ),
        DeviceMatcher("; {0,2}(T-Mobile myTouch) Build", None, "$1", "Huawei", "U8680"),
        DeviceMatcher(
            "; {0,2}(T-Mobile_Espresso) Build", None, "$1", "HTC", "Espresso"
        ),
        ...
        DeviceMatcher(
            "\\b(T-Mobile)[_ ]?(.{0,200}?)Build", None, "$1 $2", "Tmobile", "$2"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "(?:(WeTab)-Browser|; (wetab) Build)", None, "$1", "WeTab", "WeTab"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "; {0,2}(iphone|iPhone5) Build/", None, "Xianghe $1", "Xianghe", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "Black[Bb]erry ([0-9]+);", None, "BlackBerry $1", "BlackBerry", "$1"
        ),
        DeviceMatcher(
            "Black[Bb]erry([0-9]+)", None, "BlackBerry $1", "BlackBerry", "$1"
        ),
        ...
        DeviceMatcher(
            "(Touch[Pp]ad)/\\d+\\.\\d+", None, "HP TouchPad", "HP", "TouchPad"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "(HbbTV)/1\\.1\\.1 \\(;;;;;\\) Maple_2011", None, "$1", "Samsung"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "(?:MSIE|XBMC).{0,200}\\b(Xbox)\\b", None, "$1", "Microsoft", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "Motorola\\-([A-Za-z0-9]+)", None, "Motorola $1", "Motorola", "$1"
        ),
        DeviceMatcher("MOTO\\-([A-Za-z0-9]+)", None, "Motorola $1", "Motorola", "$1"),
        DeviceMatcher(
            "MOT\\-([A-z0-9][A-z0-9\\-]*)", None, "Motorola $1", "Motorola", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "Nintendo (DS|3DS|DSi|Wii);", None, "Nintendo $1", "Nintendo", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher("Philips ([A-Za-z0-9]+)", None, "Philips $1", "Philips", "$1"),
        DeviceMatcher(
            "(SMART-TV); .{0,200} Tizen ", None, "Samsung $1", "Samsung", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "SAMSUNG-ANDROID-MMS/([^;/]{1,100})", None, "$1", "Samsung", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "Android [^;]{1,200}; ([^ ]+) (Sony)/", None, "$2 $1", "$2", "$1"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "Puffin/[\\d\\.]+AT", None, "Generic Tablet", "Generic", "Tablet"
        ),
        DeviceMatcher(
        ...
        DeviceMatcher(
            "^(Ice)$", None, "Generic Feature Phone", "Generic", "Feature Phone"
        ),
        DeviceMatcher(
