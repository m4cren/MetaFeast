...
class GreenSSLSocket(_original_sslsocket):
    ...
    def write(self, data):
        ...
        return self._call_trampolining(super().write, data)

    def read(self, len=1024, buffer=None):
        """Read up to LEN bytes and return them.
        Return zero-length string on EOF."""
        try:
            return self._call_trampolining(super().read, len, buffer)
        except IOClosed:
            if buffer is None:
                return b""
            else:
    ...
    def send(self, data, flags=0):
        if self._sslobj:
            return self._call_trampolining(super().send, data, flags)
        else:
    ...
    def unwrap(self):
        return GreenSocket(self._call_trampolining(super().unwrap))

    def do_handshake(self):
        """Perform a TLS/SSL handshake."""
        return self._call_trampolining(super().do_handshake)
