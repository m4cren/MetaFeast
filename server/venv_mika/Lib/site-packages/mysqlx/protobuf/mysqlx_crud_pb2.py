...
_COLUMN.fields_by_name["document_path"].message_type = (
    mysqlx__expr__pb2._DOCUMENTPATHITEM
)
...
_UPDATEOPERATION.fields_by_name["source"].message_type = (
    mysqlx__expr__pb2._COLUMNIDENTIFIER
)
