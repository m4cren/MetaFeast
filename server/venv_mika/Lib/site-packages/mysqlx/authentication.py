...
class MySQL41AuthPlugin(object):
    def __init__(self, username, password):
        ...
        self._password = (
            ...
            if isinstance(password, UNICODE_TYPES)
            else password
        )
    ...
    def build_authentication_response(self, data):
        ...
        if self._password:
            ...
            auth_response = self.xor_string(h1, hashlib.sha1(data + h2).digest())
            return "{0}\0{1}\0*{2}\0".format("", self._username, hexlify(auth_response))
        else:
